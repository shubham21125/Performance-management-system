...
export default function AddReviewPage() {
  ...
  useEffect(() => {
    ...
    async function loadReportees() {
      try {
        const res = await api.getReportees();
  ...
  return (
    <div className="app-layout">
      ...
      <div className="main-content">
        <Navbar title="Add Performance Review" />
        ...
        <main className="page-body">
          ...
          <div className="card form-card">
            <h2 className="card-title">Create Performance Assessment</h2>
            ...
            <form onSubmit={handleSubmit} className="form-grid">
              ...
              <div className="form-group">
                ...
                <input
                  ...
                  placeholder="e.g. Q3 Technical Leadership Review"
              ...
              <div className="form-group">
                ...
                <textarea
                  ...
                  placeholder="Provide qualitative feedback on milestones, competencies, and areas for improvement..."
